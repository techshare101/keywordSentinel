...
-- Insert production plan metadata
...
VALUES
  ...
  ('starter', 'Starter', 'price_1SiY2cGRxp9eu0DJAJYpdXsJ', 29, 7, 15, FALSE, FALSE, FALSE, TRUE, FALSE, 10, FALSE, FALSE, 1, FALSE),
  ('pro', 'Pro', 'price_1SiY5EGRxp9eu0DJvWHdVl9N', 79, 15, 15, TRUE, TRUE, TRUE, TRUE, TRUE, 50, FALSE, FALSE, 3, TRUE),
  ('business', 'Business', 'price_1Sj6eiGRxp9eu0DJbHRNt868', 199, 25, 48, TRUE, TRUE, TRUE, TRUE, TRUE, 200, TRUE, TRUE, 10, TRUE)
